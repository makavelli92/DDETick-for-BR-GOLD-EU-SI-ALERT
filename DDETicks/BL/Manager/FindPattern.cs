    ...
    class FindPattern
    {
        ...
        public void StartFind(Ticks ticks)
        {
            if (ticks.date.Count > 0)
            {
                ...
                SumVolumeInCluster(ticks.LastClaster(300), sumCandleVolume);
                SingleClusterVolume(ticks.LastClaster(300), singleClasterVolume, 5);
                SingleClusterVolume(ticks.LastClaster(1500), singleClasterVolumeFor5Minut, 15);
                NeighborClusterVolumeSum(ticks.LastClaster(300), 2, neighborVolume);
                VolumeDensity(ticks.LastClaster(300), 5, neighborVolForDensity);
